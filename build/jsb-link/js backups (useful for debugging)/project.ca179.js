...
var t = this, e = cc.delayTime(2.5), o = cc.callFunc(function() {
t.score.string = "+" + t.logic.templateCoin.toString();
t.panel_node.active = !0;
}), n = cc.delayTime(3.5), i = cc.callFunc(function() {
console.log("action4");
t.panel_node.active = !1;
});
this.node.runAction(cc.sequence(e, o, n, i));
};
e.prototype.hide = function() {
this.panel_node.active = !1;
};
e.prototype.unregisrterEvent = function() {
...
__decorate([ r(cc.Label) ], e.prototype, "score", void 0);
return e = __decorate([ i ], e);
}(cc.Component);
o.default = a;
cc._RF.pop();
